...
export const services: ServiceDetail[] = [
  {
    ...
    shortSummary:
      'Full-time engineering talent with a success-based model. Fee is due when a hire is made.',
    fullDescription:
      'Designed for teams that need targeted technical hires without locking into long-term retainers. Aurtiro calibrates directly with hiring leaders, runs full-cycle sourcing, and drives close with structured signal.',
    deliverables: [
      'Role calibration with hiring manager and interview panel',
      'High-signal technical sourcing and screening',
      'Offer close support and compensation benchmarking',
      'Weekly pipeline reporting and risk callouts'
    ]
  },
  {
    id: 'retained-search',
    ...
    shortSummary:
      'Built for multiple openings or sustained growth where strategic recruiting partnership is required.',
    fullDescription:
      'Retained engagements support companies scaling several teams at once. This model prioritizes velocity, consistency, and executive-level alignment across every search while preserving candidate quality bar.',
    deliverables: [
      'Quarterly hiring plan and sequencing',
      'Multi-role sourcing pods and pipeline orchestration',
      'Interview design and interviewer calibration',
      'Leadership-ready recruiting analytics and forecasts'
    ]
  }
];
...
export const featuredCandidateTestimonials = candidateTestimonials.slice(0, 3);
...
export const featuredClients = clientLogos.slice(0, 10);

export const recruitmentProcess: ProcessStep[] = [
  {
    title: 'Intake + Calibration',
    description:
      'Aurtiro aligns on role outcomes, target profile, compensation guardrails, and interview scorecards before outreach begins.'
  },
  {
    title: 'Market Mapping + Outreach',
    description:
      'Searches are executed with targeted technical sourcing and differentiated candidate messaging tailored to your brand.'
  },
  {
    title: 'Interview Operations',
    description:
      'Feedback discipline, interviewer quality control, and pipeline prioritization are managed end-to-end to reduce cycle time.'
  },
  {
    title: 'Offer + Close',
    description:
      'Aurtiro supports closing strategy, negotiation posture, and stakeholder alignment through acceptance.'
  }
];

export const philosophyPoints = [
  'Recruiting should be consultative and data-backed, not transactional.',
  'Candidate quality is non-negotiable even under aggressive hiring timelines.',
  'Transparent communication with both clients and candidates is part of the product.'
];

export const talentBarPoints = [
  'Role-specific technical calibration for every opening',
  'Structured interview signal collection and debrief rigor',
  'Long-term team fit over short-term pipeline volume'
];

export const recognitionItems = [
  'Rookie of the Year (Motion Recruitment)',
  'Textio Interrupting Bias in Hiring Certification',
  'Global interview training program design and rollout leadership'
];
...
export const platformModules: PlatformModule[] = [
  {
    ...
    status: 'In Build',
    description:
      'Resume submission, profile tracking, role matching preferences, and communication timeline in one flow.'
  },
  {
    title: 'Client Intake + Pipeline Workspace',
    status: 'In Build',
    description:
      'Hiring requests, role briefs, interviewer assignments, and stage-level pipeline visibility for hiring teams.'
  },
  {
    title: 'Auth + Identity Layer',
    status: 'Planned',
    description:
      'Secure user accounts, role-based access, and session controls for hiring managers, candidates, and operators.'
  },
  {
    title: 'CRM / ATS Integration Layer',
    status: 'Planned',
    description:
      'API adapters and event hooks to synchronize candidate records and interview activity into a custom CRM/ATS.'
  }
];
